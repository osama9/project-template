...
///#endregion
  ...
  ************************************/
    extend(getPrototypeOf(moment.localeData()), {
        ...
        _hMonthsShort: [
            'Muh', 'Saf', 'Rab-I', 'Rab-II', 'Jum-I', 'Jum-II', 'Raj', 'Sha', 'Ram', 'Shw', 'Dhu-Q', 'Dhu-H'
        ],
    ...
    ************************************/
	...
	hMoment.loadArabic = function () {
	    ...
	    moment.locale('ar-sa', {
	        ...
	        week: {
	            dow: 5 // Saturday is the first day of the week.
	            ,
	...
	hMoment.loadArabicWithArabicDigit = function () {
	    var symbolMap = {
	        '1': '١',
	        '2': '٢',
	        '3': '٣',
